# vSphere Kubernetes Service (VCF Version 9.0)

## Description

VMware Cloud Foundation (VCF) VKS (vSphere Kubernetes Service) is an enterprise-grade, CNCF-conformant Kubernetes runtime integrated directly into the VCF private cloud platform. It allows IT teams to manage virtual machines (VMs) and containers side-by-side on the same infrastructure, providing self-service provisioning, built-in security, and automated lifecycle management for Kubernetes clusters.

These assets serve as a starting point for designing and deploying a  *vSphere Kubernetes Service* customer engagement. This content is intended to be used as part of a Day 1,2, and N deployment.
...
The prerequisite checklist for this component is located in this folder. Ths check list is named *VCFVKS_PrerequisiteChecklist* and is available in Microsoft Excel format.

## Installation

Refer to VKS Installation and Configuration Procedures documentation for full VKS installation guidance.
