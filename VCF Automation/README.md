# VMware Cloud Foundation Automation (component) (VCF Version 9.0)

## Description

VCF Automation is a key component of VMware Cloud Foundation that provides a self-service, policy-governed private cloud, allowing IT teams to deliver "Infrastructure as a Service" (IaaS) for VMs, Kubernetes, and AI workloads. It enables automated provisioning, scaling, and lifecycle management of resources, transforming IT administrators into cloud service providers. 

These assets serve as a starting point for designing and deploying a *VMware Cloud Foundation Automation* customer engagement. This content is intended to be used as part of a Day 1,2, and N deployment.
...
The prerequisite checklist for this component is located in this folder. Ths check list is named *VCFA_PrerequisitesChecklist* and is available in Microsoft Excel format.
