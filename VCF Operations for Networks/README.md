# VMware Cloud Foundation Operations for networks (component) (VCF Version 9.0)

## Description

VMware Cloud Foundation Operations for networks is an on-premises network monitoring and troubleshooting tool designed to provide end-to-end visibility across virtual and physical network infrastructures. It helps optimize, secure, and troubleshoot VCF and NSX environments by analyzing traffic flows, mapping applications, and offering AI-driven insights for network performance. 

These assets serve as a starting point for designing and deploying a *VMware Cloud Foundation Operations for networks* customer engagement. This content is intended to be used as part of a Day 1,2, and N deployment.

**Now offering design diagrams via LucidCharts. See the EDM Bill-of-Materials section for more details.**
...
The prerequisite checklist for this component is located in this folder. Ths check list is named *VCFON_PrerequisitesChecklist* and is available in Microsoft Excel format.

## Installation

Installation of this component is performed via VCF Operations Fleet Management inside VCF Operations.
...
The documents in this folder follow the standard bill of materials, which includes the following documents:
