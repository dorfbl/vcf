# variables.tf for VCF 5.1 Bringup - last updated on 12-1-2023
...
##### VM_MANAGEMENT Network Details #####

variable "vm_management_subnet" { default = "10.0.0.0/24" }
variable "vm_management_gw" { default = "10.0.0.1" }
variable "vm_management_vlan" { default = "2000" }
variable "vm_management_mtu" { default = "8000" }
variable "vm_management_portgroup" { default = "pse-m01-dv01-pg-vm-mgmt" }

##### ESXi Host MANAGEMENT Network Details #####
...
variable "vcenter_ip" { default = "10.0.0.10" }
...
variable "nsx_manager_ip_vip" { default = "10.0.0.11" }
variable "nsx_manager_name1" { default = "nsx01a" }
variable "nsx_manager_ip1" { default = "10.0.0.12" }
variable "nsx_manager_name2" { default = "nsx01b" }
variable "nsx_manager_ip2" { default = "10.0.0.13" }
variable "nsx_manager_name3" { default = "nsx01c" }
variable "nsx_manager_ip3" { default = "10.0.0.14" }

##### SDDC Manager #####

variable "sddc_manager_name" { default = "sddc-manager-1" }
variable "sddc_manager_ip" { default = "10.0.0.5" }
